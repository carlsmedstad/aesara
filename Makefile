...
check-format:
	...
	black -t py36 --check ${PROJECT_DIR} tests/ conftest.py
	isort --check ${PROJECT_DIR} tests/ conftest.py
...
format:  # Format code in-place using black.
	black ${PROJECT_DIR} tests/ conftest.py
	isort ${PROJECT_DIR} tests/ conftest.py
